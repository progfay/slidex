...
ローカルサーバーが使えない環境(スマホなど)からレビューしたいと言われたら
`preview` skill を使う(デッキ一式を1枚の自己完結HTMLに束ねて Claude Code の
Artifact として publish する。手順は `.claude/skills/preview/SKILL.md` 参照)。
